...
#ifndef LIB_MADNEX_FCSTRING_IXX
#define LIB_MADNEX_FCSTRING_IXX
...
namespace madnex {
  ...
  basic_fcstring<N, CharT, Traits>& basic_fcstring<N, CharT, Traits>::operator=(
    ...
    madnex::raise_if<std::length_error>(s > N,
  ...
  CharT& basic_fcstring<N, CharT, Traits>::at(const std::size_t i) {
    madnex::raise_if<std::out_of_range>(i >= N,
  ...
  CharT& basic_fcstring<N, CharT, Traits>::back() {
    madnex::raise_if<std::length_error>(this->empty(),

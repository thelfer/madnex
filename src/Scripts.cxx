...
static H5::CompType getScriptCompType(){
  ...
  c.insertMember("command_line",HOFFSET(Script,command_line),StrType(0,500));
  c.insertMember("script_version", HOFFSET(Script,script_version),StrType(0,10));
  return c;
...
namespace madnex{
  ...
  void write(Group& g,const std::string& n,
  	     const Scripts& o)
  {
  ...
  void read(Scripts& o,const Group& g,
	     const std::string& n)
  {
